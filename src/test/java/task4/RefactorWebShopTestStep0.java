...
// STEP 0: CODE WITHOUT REFACTORING

public class RefactorWebShopTestStep0 {
    ...
    @Test
    public void emailPwdFieldsBlank() {
    ...
    @Test
    public void validPwdInvalidEmailFormat() {
        WebElement signInLink;
        WebElement emailField;
        WebElement passwordField;
        WebElement signInBtn;
    ...
    @Test
    public void validEmailEmptyPwd() {
        WebElement signInLink;
        WebElement emailField;
        WebElement signInBtn;
        WebElement noEmailPwdMsg;
